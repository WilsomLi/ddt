...
namespace PSDUIImporter
{
    public class PSDImportCtrl
    {
		...
		private void GeneraPrefab(Transform obj)
		{
			string path = PSDImporterConst.PREFAB_PATH + obj.name + PSDImporterConst.PSDUI_SUFFIX;
			PrefabUtility.CreatePrefab (path, obj.gameObject, ReplacePrefabOptions.ConnectToPrefab | ReplacePrefabOptions.ReplaceNameBased);
			Debug.Log ("-------------导出成功：" + path);
		}
